...
/// <summary>
/// One error charged during a play, identifying the fielder and the manner of the error.
/// </summary>
/// <param name="FielderPosition">The fielder's position number (1-9) charged with the error.</param>
/// <param name="ErrorType">
/// The kind of error: <c>T</c> (throwing), <c>F</c> (fumbled ball), or <c>D</c> (dropped throw).
/// </param>
public readonly record struct FieldingError(int FielderPosition, char ErrorType);
